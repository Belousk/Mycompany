...
stpbl1.onmouseover = function() {
	stpbrdr1.style.borderColor = "white";
};

stpbl1.onmouseout = function() {
	stpbrdr1.style.borderColor = "black";
};
...
stpbl2.onmouseover = function() {
	stpbrdr2.style.borderColor = "white";
};

stpbl2.onmouseout = function() {
	stpbrdr2.style.borderColor = "black";
};
...
stpbl3.onmouseover = function() {
	stpbrdr3.style.borderColor = "white";
};

stpbl3.onmouseout = function() {
	stpbrdr3.style.borderColor = "black";
};
